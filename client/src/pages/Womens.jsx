...
const Womens=()=>{
    ...
    const loaddata=()=>{
        let api="https://sports-ecommerce-website.onrender.com/product/productcategory?category=womens";
  ...
  const addtocardData=(id,name,desc,cate,price,img)=>{
    ...
    return(
        ...
        <h1 style={{alignItems:"center",textAlign:"center",padding:"30px 0px 30px 0px"}}>Womens Category</h1>
